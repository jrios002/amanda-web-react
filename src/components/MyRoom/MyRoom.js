...
const MyRoom = () => {
	return (
		<div style={{borderBottomStyle: "solid", borderBottomColor: "black", borderBottomWidth: "2px"}}>
			...
			<div className="flex justify-center items-start mt2 mb6">
				...
				<p className="regText ma2 white w-30 fw6">Hello all, I am Mrs Rios and welcome to my classroom. Let me tell
